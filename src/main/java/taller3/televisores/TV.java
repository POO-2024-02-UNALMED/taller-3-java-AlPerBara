...
public class TV {
    ...
    public void setCanal(int canal) { //setter canal
        if ((canal >=1)&&(canal <=120)&& (this.estado)){ //Poner un canal, debe ser mayor o igual a 1, menor o igual a 120 y estar encendido el tv
            this.canal = canal;
        }
    }
    ...
    public void setVolumen(int volmen) { //setter volumen
        if ((volmen >=0)&&(volmen <=7)&& (this.estado)){ //Poner el volumen, debe ser mayor o igual a 0, menor o igual a 7 y estar encendido el tv
            this.volumen = volmen;
        }
    }
